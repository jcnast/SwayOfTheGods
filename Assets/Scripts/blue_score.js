...
function Update ()
{
	...
	if (Time.time > tick_time)
	{
		...
		transform.localScale.x += (blue_gods - red_gods)/600.0; // Teams start with 300 pts each, so it is out of 600 total
		transform.localPosition.x += (blue_gods - red_gods)/600.0; // Teams start with 300 pts each, so it is out of 600 total
